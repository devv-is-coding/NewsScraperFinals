...
const UrlInput = ({ onScrape, isLoading }) => {
  ...
  const popularSites = [
    ...
    { name: "ABS-CBN", url: "https://www.abs-cbn.com/news" },
    { name: "GMA News", url: "https://www.gmanetwork.com/news/" },
  ];
    ...
    <div className="bg-white rounded-2xl shadow-md p-6 mb-8">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full sm:w-auto bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-semibold py-3 px-6 rounded-xl transition-all duration-200 transform hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
          >
            {isLoading ? (
      ...
      <div className="mt-6">
        <p className="text-sm text-gray-600 mb-3">
          Quick start with popular news sites:
        </p>
